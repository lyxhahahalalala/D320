 ...
 * Mod. Date     : $Date: 2014/07/02 15:56:10MESZ $
 ...
 *********************************************************************************************************************/
    ...
    #define CPU_FREQUENCY_MHZ       (160)                           /**< CPU frequency in MHz */
    ...
    #define FDL_POOL_SIZE           (32u * EEL_VIRTUALBLOCKSIZE)    /**< Number of Data Flash blocks, accessible by  16
    ...
    #define EEL_POOL_SIZE           (0u * EEL_VIRTUALBLOCKSIZE)     /**< no. of blocks for the EEL pool   6*/
