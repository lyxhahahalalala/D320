...
#define DHD_VIDMEM_FLINDEX_MAX    30                       /* entries in first level table (maximum allocation size is 1<<FLINDEX_MAX)*/
#define DHD_VIDMEM_SLCOUNT_LOG2   5                        /* log2 of second level linear subdivisions for each block size */

/*----------------------------------------------------------------------------------------------------------*/
/* derived constants*/

#define DHD_VIDMEM_MINALIGN       (1u << DHD_VIDMEM_MINALIGN_LOG2)
#define DHD_VIDMEM_SLCOUNT        (1u << DHD_VIDMEM_SLCOUNT_LOG2)
#define DHD_VIDMEM_FLSHIFT        (DHD_VIDMEM_SLCOUNT_LOG2 + DHD_VIDMEM_MINALIGN_LOG2)
#define DHD_VIDMEM_FLCOUNT        ((DHD_VIDMEM_FLINDEX_MAX - DHD_VIDMEM_FLSHIFT) + 1)
#define DHD_VIDMEM_SMALLBLOCK     (1u << DHD_VIDMEM_FLSHIFT)
