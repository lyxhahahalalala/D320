...
CAN_MESSAGE msg_get;
volatile char CAN_CanRxMsgFlag;//接收到CAN数据后的标志
volatile unsigned long CAN_RxId;
...
static void Can_SetRxRule(void)
{
    ...
    RSCAN0.GAFLID6.UINT32      = 0x98DA17F0UL; /* Standard ID, Data frame */
   // RSCAN0.GAFLID6.UINT32      = 0x18DA17F1UL; /* Standard ID, Data frame */
    RSCAN0.GAFLID12.UINT32     = 0x00000000UL;
    //RSCAN0.GAFLID12.UINT32     = 0x80000150UL; /* Extended ID, Data frame 0x000150*/
    ...
    RSCAN0.GAFLM6.UINT32      =  0x9FFFFFF0UL;
    RSCAN0.GAFLM12.UINT32     =  ~0x000006FFUL;
    //RSCAN0.GAFLM12.UINT32     = 0x00000150UL;
    ...
    RSCAN0.GAFLP06.UINT32     = 0x00000100UL;
    RSCAN0.GAFLP012.UINT32    = 0x000006F0UL;
...
void CAN1_SendMessage(CAN_MESSAGE *message)
{
	...
	RSCAN0.TMID16.UINT32    |= 0x80000000;
        /* Set RSCAN0TMIDp register.
