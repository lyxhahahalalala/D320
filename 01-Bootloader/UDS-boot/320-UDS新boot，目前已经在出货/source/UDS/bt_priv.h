...
/* Configure the BSmax timeout value in ms */
#define  TP_TOBSMAX    25ul
/* Configure the Crmax timeout value in ms */
#define  TP_TOCRMAX    150ul
/* Configure the Block Size max value is 255 */
#define  TP_BSMAX      0
/* Configure the minimum seperation time in ms . Max value 255ms */
#define  TP_STMIN      0
/* Configure the maximum number of waittosend FC to be sent*/
#define  TP_NUMWAIT2FC 0

/* Maximum time (microsec) between two calls of BT_Al_Proc */
#define BT_MAX_PERIOD (1) 

/* The max length of data in telegram.  */
#define BT_MAX_DATA_LENGTH 4095
/*
 *********************************************************************
 * Defines
 *********************************************************************
...
#define POS_RESPONSE_ADDER (uint8)(0x40)
#define NEG_RESPONSE_CODE   ((uint8)0x7F)
#define SERVICE_NOT_SUPPORTED_CODE ((uint8)0x11)
#define SERVICE_NOT_SUPPORTED_INACTIVESESSION ((uint8)0x7F)
#define SUBFUNC_NOT_SUPPORTED_CODE ((uint8)0x12)
...
typedef enum
{
    NO_RESPONSE_AGAIN = 0x00,
    NO_RESPONSE,
    RESPONSE_OK,
    RESPONSE_PENDING,
    RESPONSE_WAITPEND,
    RESPONSE_WAITBUSYREPEAT,
} BT_RESPONSE_e;
...
//extern uint32 BT_TpTiming_toBsmax_u32;
#define BT_TpTiming_toBsmax_u32 (TP_TOBSMAX)

/* Crmax timings in ticks */
//extern uint32 BT_TpTimingCfg_toCrmax_u32;
...
extern uint8  BT_stChgReq_u8;

/* General definitions */
extern   uint8* BT_dAlBuf_pu8;

/* Status Register */
extern   uint8 BT_statusAl_u8;

/* P3 timer */
extern   uint32 BT_toAlTxTim_u32;

/* P2 timer */
extern   uint32 BT_toAlRxTim_u32;

/* S3 timer */
extern   uint32 BT_toS3Tim_u32;

/* Defination of the BT_ServiceMsg_s */
extern BT_ServiceMsg_t* BT_ServiceMsg_ps;

/* Wait mode active */
extern bool BT_stAlWaitmode_b;

/* Response type */
extern uint8    BT_stAlSerResp_u8;

/* Number of bytes to be transmitted */
extern uint16 BT_numAlTxBytes_u16;

extern uint8 BT_dAlHelpBuf_au8[BT_HELPBUFLEN];
/* Service Message */
extern BT_ServiceMsg_t BT_ServiceMsg_s;
 ...
 *********************************************************************
 */
extern bool BT_TpTxmsg (uint8* databuff_pu8, uint16  datalength_u16 );

extern    void BT_TpFFInd ( void );
/* Indication */

extern void BT_TpInd (uint8 Nl_handle_u8, uint16  dataLength_u8, uint16 Nl_Result_u16);
/* Confirmation */

extern   void BT_TpConfirm ( uint16 Nl_Result_u16 );

/* Setting of the buffer */
extern void BT_TpSetBuffer( uint8* data_pu8, uint16 bufferlength_u16 );
...
extern  void BT_CopyData(uint8* src_pu8, uint8* dest_pu8, uint8 len_u8);
