...
extern int e_total_miles;
extern int e_address; //EEPROM存储地址
extern int e_single_miles;
extern int e_backlight;
extern int e_hm_pulse;
...
/*按键控制接口 */
#if 0
#define KEY_AV       (!PORT_ISO.PPR17.BIT.PPR17_8)       //S1
#define KEY_AV_DR    0

#define KEY_SET        (!PORT_ISO.PPR17.BIT.PPR17_9)      //S2
#define KEY_SET_DR     0

#define KEY_UP         (!PORT_ISO.PPR17.BIT.PPR17_10)       //S6
#define KEY_UP_DR      0
#endif

#if 0
#define KEY_AV                 (PORT_ISO.PPR3.BIT.PPR3_4) 
#define KEY_AV_DR           (PORT_ISO.PPR3.BIT.PPR3_5)
#define KEY_SET               (PORT_ISO.PPR3.BIT.PPR3_6)
#define KEY_SET_DR         (PORT_ISO.PPR3.BIT.PPR3_7)
#define KEY_UP                 (PORT_ISO.PPR3.BIT.PPR3_8)
#define KEY_UP_DR           (PORT_ISO.PPR10.BIT.PPR10_8)
#endif

#if 1
#define KEY_AV                 (PORT_ISO.PPR10.BIT.PPR10_8)
#define KEY_AV_DR           0
#define KEY_SET               (PORT_ISO.PPR3.BIT.PPR3_7)
#define KEY_SET_DR         0
#define KEY_UP                 (PORT_ISO.PPR3.BIT.PPR3_8)
#define KEY_UP_DR           0
#endif
...
void Count_ADR_BK(void) ;
void __Count_ADR(void);
