...
* Mod. Date     : $Date: 2016/01/18 19:54:42MEZ $
...
Macro definitions
************************************************************************************************************/
#define FCL_CPU_FREQUENCY_MHZ  160                            /*!< CPU frequency in MHz */
#define FCL_AUTHENTICATION_ID {0xFFFFFFFF, \
                               0xFFFFFFFF, \
                               0xFFFFFFFF, \
                               0xFFFFFFFF}                    /*!< 128Bit authentication ID */
#define FCL_RAM_ADDRESS        0xFEDF4000                     /*!< RAM address range blocked for FCL */
