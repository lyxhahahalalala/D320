...
/*----------------------------------------------------------------------------------------------------------*/
/* Setup an edge from two points without AA or tie breaking. */
/* This function is faster than dhd_setup_edge_noaa (actually it is the fastest possible way to setup an*/
/* arbitrary edge) but will not automatically ensure gapless rendering for shared edges. */
/* The application has to specify E_DHD_INVERT flag on one part of a shared edge pair to ensure gapless*/
/* rendering. */
/**/
...
/*----------------------------------------------------------------------------------------------------------*/
/* Setup an edge from two points without AA. */
/* This function is slower than dhd_setup_edge_noaa_notie but will apply tie breaking rules to ensure*/
/* gapless rendering for shared edges, even when the application can not (or does not want to) use*/
/* E_DHD_INVERT flags.*/
/**/
/* All points in screenspace pixel coordinates using 4 bit fraction. */
/**/
