...
{
	UDS_SESSION_NONE = 0, /*空*/
	UDS_SESSION_STD,      /*默认模式*/
	UDS_SESSION_PROG,     /*编程模式*/
	UDS_SESSION_EOL,      /*扩展模式*/
	UDS_SESSION_SAFTY     /*安全模式*/
}uds_session_t;
...
#define UDS_REQUEST_SEED_SECURITY         (0x07)
#define UDS_SEND_KEY_SECURITY             (0x08)
