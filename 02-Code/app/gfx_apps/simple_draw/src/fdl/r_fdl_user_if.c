 ...
 * Mod. Revision : $Revision: 1.41 $
 * Mod. Date     : $Date: 2014/08/26 11:51:30MESZ $
 ...
 * @param[out] tmpStat      - Status return value. Is set to operation result. Possible values:
 *                              - R_FDL_BUSY
 *                              - R_FDL_ERR_PARAMETER
                                                   ...
                                                   r_fdl_flag_t      isCalledFromExecute_enu)
{
    ...
    if (R_FDL_TRUE == isCalledFromExecute_enu)
    {
        ...
        /* Reset flag, in case the calling function is R_FDL_Execute                     */
        /* Flag is updated later on in case the switch mode to PE is performed correctly */
        cont = R_FDL_FALSE;
    }
